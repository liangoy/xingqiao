...
data = list(col.find({'createTime':{'$lt':'2017/11/5'}}, {'_id': 0, 'status': 1, 'msgCut': 1}))[:-256*2]
...
c1 = ml.conv2d(X, conv_filter=[2, 60, 1, 1], padding='VALID', ksize=[1, 50, 1, 1], pool_stride=[1, 200, 1, 1],
               pool_padding='VALID')
...
optimizer = tf.train.AdamOptimizer(learning_rate=0.01).minimize(all_loss)
# ...................................................................
sess = tf.Session()
