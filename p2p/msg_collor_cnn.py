...
c1 = ml.conv2d(X, conv_filter=[3, 60, 1, 1], padding='VALID', ksize=[1, 500, 1, 1], pool_stride=[1, 200, 1, 1],
               pool_padding='VALID')
...
optimizer = tf.train.AdamOptimizer(learning_rate=0.005).minimize(all_loss)
# ...................................................................
sess = tf.Session()
